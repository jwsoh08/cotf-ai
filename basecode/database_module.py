...
def delete_tables():
    ...
    ]  # "sqlite_sequence" is a system table
    ...
    confirm_drop = st.checkbox(
        "I understand the consequences. Proceed to drop selected tables."
    )
        ...
        if btn_process:
            ...
            for user_id in user_ids:
                for function_name in selected_function_names:
                    ...
                    cursor.execute(
                        "INSERT INTO App_Functions_Link(app_function_id, user_id) VALUES (?, ?)",
        ...
        for foldername, subfolders, filenames in os.walk(directory):
            for filename in filenames:
                ...
                relative_path = absolute_path[
                    len(directory) + len(os.sep) :
                ]  # Zip won't contain absolute path
